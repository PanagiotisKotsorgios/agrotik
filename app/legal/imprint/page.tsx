...
export default function ImprintPage() {
  return (
    <ProsePage eyebrow="Νομικά" title="Στοιχεία εταιρείας">
      <h2>Επωνυμία</h2>
      <p><strong>AGROTIK</strong> — πλατφόρμα σύνδεσης αγροτικής και αλιευτικής αγοράς.</p>
      ...
      <p>
        ...
        αγροτικών και αλιευτικών προϊόντων. Δεν συμμετέχει σε συναλλαγές, δεν προμηθεύει
