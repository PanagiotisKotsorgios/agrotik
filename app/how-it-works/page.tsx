    ...
    <>
      ...
      <main className="max-w-5xl mx-auto px-4 py-12">
        ...
        <ol className="mt-10 grid gap-4 sm:grid-cols-3 list-none">
          <StepCard n={1} icon="user" title="Δημιούργησε προφίλ" body="Επίλεξε ρόλο (αγρότης, έμπορος, εργοστάσιο), συμπλήρωσε βασικά στοιχεία και ξεκίνα." />
          <StepCard n={2} icon="tag" title="Καταχώρησε δεδομένα" body="Αγρότες: τη διαθέσιμη παραγωγή. Έμποροι/εργοστάσια: τιμοκατάλογο ανά προϊόν και ποιότητα." />
          ...
          <div className="grid md:grid-cols-3 gap-4">
            ...
            <RoleDetails
              ...
              points={[
                ...
                "Ενημερώνεις τιμές κάθε μέρα — οι αγρότες βλέπουν πραγματικά δεδομένα.",
                "Ψάχνεις παραγωγή ανά νομό, ποσότητα, ημερομηνία.",
              ]}
            />
            <RoleDetails
              icon="industry"
              ...
              points={[
                ...
                "Χτίζεις σχέσεις μακροπρόθεσμα με τους παραγωγούς.",
              ]}
            />
          </div>
        </section>
